        ...
        <div className='grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-6 h-auto md:h-[800px]'>
            ...
            <div className='relative z-10 h-full flex flex-col justify-between'>
              <div>
                ...
                <p className='text-lg opacity-80'>
                  Stop watching tutorials. Start building. We focus on
                  real-world projects that simulate actual industry work
                  environments.
                </p>
              </div>
              <div className='mt-8'>
                <div className='flex -space-x-4'>
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className='w-12 h-12 rounded-full border-4 border-base-100 bg-base-300 flex items-center justify-center font-bold'
                    >
                      P{i}
                    </div>
                  ))}
          ...
          >
            ...
            <div>
              ...
              <p className='text-sm opacity-70'>
                Learn directly from a Full Stack Developer.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className='text-sm opacity-70'>
                Don't just get a certificate. Build a GitHub that gets you
                hired.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className='relative z-10'>
              ...
              <p className='opacity-90'>
                From resume building to mock interviews, we handle it all.
              </p>
              <div className='mt-4 flex gap-2'>
                <span className='badge badge-ghost text-white'>
                  Resume Review
                </span>
                <span className='badge badge-ghost text-white'>
                  Mock Interviews
          ...
          >
            <div className='h-full flex flex-col items-center text-center justify-center'>
              ...
              <p className='text-sm opacity-70'>
                Join 500+ developers in our exclusive Discord & WhatsApp groups.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className='text-xs opacity-60 mt-2'>
                Personalized feedback on every line of code you write.
              </p>
            </div>
          </motion.div>
        </div>
