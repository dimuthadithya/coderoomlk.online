...
const courses = [
  {
    ...
    description:
      'Master MERN stack with React, Node.js, Express, and MongoDB. Build production-ready applications from scratch.',
  ...
  },
  {
    ...
    description:
      'Deep dive into React, Next.js, TypeScript, and modern UI libraries. Create stunning, responsive interfaces.',
  ...
  },
  {
    ...
    description:
      'Build scalable APIs with Node.js, databases, authentication, and deploy to cloud platforms.',
  ...
  },
  {
    ...
    description:
      'Learn Python, Django, REST APIs, and build modern web applications with Python ecosystem.',
  ...
  },
  {
    ...
    description:
      'Create cross-platform apps with React Native. Deploy to iOS and Android app stores.',
  ...
  },
  {
    ...
    description:
      'Master databases, Docker, Kubernetes, CI/CD pipelines, and cloud infrastructure management.',
      ...
      <div className='max-w-7xl mx-auto px-4 relative z-10'>
        ...
        >
          ...
          <p className='text-xl text-base-content/70 max-w-2xl mx-auto'>
            Industry-focused curriculum designed by experts. Learn by building
            real-world projects.
          </p>
        </motion.div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {courses.map((course, index) => (
            ...
            >
              <div
                className={`card glass-card hover:glow-card transition-all duration-300 h-full relative overflow-hidden ${
              ...
              >
                ...
                <div className='card-body relative z-10'>
                  <div
                    className={`text-${course.color} mb-4 transform group-hover:scale-110 transition-transform duration-300`}
                  >
                    {course.icon}
                  </div>
                  ...
                  <div className='flex gap-2 my-4 flex-wrap'>
                    {course.features.map((feature, i) => (
                      <div
                        key={i}
                        className={`badge badge-${course.color} badge-outline badge-sm`}
                      >
                        {feature}
                      </div>
                    ))}
          ...
          <div className='card glass-card glow-card'>
            <div className='card-body items-center text-center'>
              ...
              <p className='text-lg text-base-content/70 mb-6'>
                We offer custom training programs tailored for teams and
                individuals.
              </p>
              <motion.a
                href='#contact'
