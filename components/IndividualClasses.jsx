        ...
        <div className='bg-gradient-to-br from-neutral to-neutral-focus text-neutral-content rounded-3xl p-8 md:p-12 overflow-hidden relative shadow-2xl'>
          ...
          <div className='flex flex-col lg:flex-row items-center gap-12 relative z-10'>
            <div className='lg:w-1/2'>
              <div className='badge badge-warning text-warning-content mb-4 font-bold border-none'>
                Premium Option
              </div>
              ...
              <p className='text-lg text-white/80 mb-8 leading-relaxed'>
                Struggling with a specific concept? Or need a fast-track to a
                job? Our **Individual Classes** offer 100% personalized
                mentorship focused entirely on YOU.
              </p>

              <div className='flex flex-wrap gap-4'>
                <a
                  href='/contact'
                  className='btn btn-warning btn-lg border-none text-neutral font-bold rounded-xl shadow-lg hover:scale-105 transition-transform'
                >
                  Book a Session
                </a>
                <a
                  href='https://wa.me/YOUR_NUMBER'
                  className='btn btn-outline btn-lg text-white border-white/20 hover:bg-white/10 hover:border-white rounded-xl'
                >
