    ...
    return (
      <div className='glass-card w-[350px] h-[280px] p-6 rounded-2xl mx-4 my-4 flex flex-col justify-between hover:scale-[1.02] transition-transform duration-300 relative group'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <div className='overflow-hidden'>
                <div className='flex items-center gap-2'>
                  <h4 className='font-bold text-base-content truncate max-w-[140px]'>
                    {testimonial.name}
                  </h4>
                  {testimonial.github && (
                    <a
                      href={getGithubLink(testimonial.github)}
                      target='_blank'
                      rel='noopener'
                      className={`text-base-content/40 hover:text-${color} transition-colors`}
                    >
                      <FaGithub />
                    </a>
                  )}
        ...
        <div className='pt-4 border-t border-base-content/5 mt-auto'>
          <div
            className={`text-xs font-bold text-${color} uppercase tracking-wide truncate`}
          >
            {testimonial.course}
          </div>
        </div>
    ...
    >
      ...
      <div className='max-w-7xl mx-auto px-4 mb-12 text-center relative z-10'>
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className='badge badge-primary px-4 py-3 mb-4 text-xs font-bold tracking-widest uppercase'>
            Community Love
          </div>
          ...
          <p className='text-xl opacity-70 max-w-2xl mx-auto'>
            From university students to industry professionals, see who's
            learning with us.
          </p>
        </motion.div>
      </div>
      ...
      <div className='text-center mt-12 relative z-10'>
        <a
          href='https://forms.gle/crFF3DiLTowEYYER7'
          target='_blank'
          rel='noopener noreferrer'
          className='group relative inline-flex items-center gap-3 px-8 py-4 bg-base-100/30 backdrop-blur-md border border-white/10 rounded-full hover:border-primary/50 transition-all duration-300 hover:shadow-[0_0_30px_-5px_var(--color-primary)] hover:-translate-y-1'
        >
                ...
                <div>
                  <h3 className='text-xl font-bold flex items-center gap-2'>
                    ...
                    {selectedTestimonial.github && (
                      <a
                        href={getGithubLink(selectedTestimonial.github)}
                        target='_blank'
                        rel='noopener'
