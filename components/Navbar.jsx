          ...
          >
            <div className='max-w-7xl mx-auto px-4 py-2 flex items-center justify-center gap-4 text-sm font-medium'>
              <span className='hidden md:inline-flex items-center gap-2'>
                {' '}
                New Batch Enrolling Now! Limited Seats Available.
              </span>
          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <div className='dropdown dropdown-end'>
                ...
                <ul
                  tabIndex={0}
                  className='dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-2xl w-48 mt-4 border border-base-content/10 gap-1'
                >
                  {[
